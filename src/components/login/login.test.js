...
describe("<Login> ", () => {
    ...
    describe("when the login block is rendered", () => {
        ...
        it("should render the correct components", () => {
            ...
            expect(centerBlock2Content).toHaveLength(2);
            ...
            expect(centerBlock2Content[0].type).toEqual(SmallSpace);
            expect(centerBlock2Content[1].type).toEqual(LinkNoDecoration);
            expect(centerBlock2Content[1].props.to).toEqual("/search");

            const secondaryButton = centerBlock2Content[1].props.children;
